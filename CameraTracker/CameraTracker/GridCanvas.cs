...
namespace CameraTracker
{
    ...
    public partial class GridCanvas : Panel
    {
        ...
        private PointF _selectionRectStartOffset = new PointF(75, 75);
        private PointF _selectionRectEndOffset = new PointF(175, 175);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            try
            {
                ...
                if (_selectionRect.HasValue)
                {
                    ...
                    var leftTop = new PointF(sel.Left + _selectionRectStartOffset.X, sel.Top + _selectionRectStartOffset.Y);
                    var rightBottom = new PointF(sel.Right + _selectionRectEndOffset.X, sel.Bottom + _selectionRectEndOffset.Y);
